...
## Run #3 Additive Conclusions (2026-05-23)

*Research window unchanged (2025-11-23 – 2026-05-23, same day as Run #2). Five new papers added across 5 sectors: GPUs paper-021 (NVIDIA Q1 FY2027 Earnings, VALIDATED), AI_accelerators paper-026 (Alibaba T-Head Zhenwu M890, VALIDATED), chip_fabrication paper-026 (ASML High-NA EUV Bifurcation, VALIDATED), edge_AI_hardware paper-024 (LlamaWeb WebGPU, VALIDATED), interconnects paper-023 (PCIe 8.0 Draft 0.5, VALIDATED).*

**[Run #3 — new conclusion]**: NVIDIA leadership has publicly confirmed a multi-year supply ceiling on its next-generation GPU platform. NVIDIA Q1 FY2027 earnings (May 20, 2026, paper-021 GPUs): CEO Jensen Huang stated Vera Rubin will be "constrained throughout the entire life of the platform." This is the first time NVIDIA management has issued a forward-looking, platform-length supply constraint on an unreleased product — converting a structural inference (CoWoS is oversubscribed, yield math is against them) into an explicit management admission. The implication for C3 (CoWoS as the gating supply constraint) is a material upgrade in confidence: the packaging bottleneck is not a sell-side inference, it is now CEO-guided. The opportunity window for CoWoS-adjacent beneficiaries (HBM4 base die suppliers, advanced substrate makers, OSAT capacity holders) extends to at least 2027-2028 by management's own account. **Confidence: very high (primary source — official earnings call transcript; Tier 1 VALIDATED).**

**[Run #3 — new conclusion]**: China's sovereign AI accelerator supply chain has crossed the hyperscaler deployment threshold. Alibaba T-Head Zhenwu M890 (paper-026 AI_accelerators): 560,000 units deployed inside Alibaba Cloud as of May 2026, at 3× prior-gen performance, 144 GB HBM3, 800 GB/s inter-chip bandwidth, on 3nm process. This is not a prototype or a roadmap claim — it is a deployed fleet larger than the total install base of several US-based alternative AI accelerator vendors combined. It materially revises the assumption (held in the AI_accelerators sector synthesis since Run #1) that no non-US vendor had achieved hyperscaler-scale deployment of competitive AI compute. The V900/J900 roadmap extends this through 2028. The implication: NVIDIA's China TAM rebound scenario (post-export control normalization) faces a permanent demand-destruction component, not merely a temporary displacement. **Confidence: high (validated vendor announcement with deployment figures; cross-checked against prior T-Head public disclosures).**

**[Run #3 — new conclusion]**: High-NA EUV is creating a two-track foundry capability bifurcation with a 2-year divergence. ASML High-NA EUV Bifurcation (paper-026 chip_fabrication): TSMC delays High-NA EUV adoption to 2029 (citing pellicle maturity and yield risk), while Samsung SF1.4, Intel 14A, and SK Hynix HBM5 all proceed on 2027-2028 schedules. This creates the first major capability-tier split among leading foundries since TSMC pulled ahead at 5nm in 2020. The consequence for C7 (EUV pellicle and stochastic patterning as the ceiling on <2nm scaling) is a partial revision: TSMC customers face this ceiling through 2028 on a rigid schedule, while Samsung/Intel customers may cross it 2 years earlier if Samsung SF1.4 yield meets the 70% SF2P baseline. The opportunity is asymmetric: High-NA EUV first-movers gain sub-8nm half-pitch patterns that enable memory density advantages (SK Hynix HBM5 differentiation) and logic shrinks unavailable to TSMC-dependent competitors. **Confidence: high (validated synthesis of multiple confirmed industry sources).**

---

## Run #4 Additive Conclusions (2026-05-23)

*Research window: 2025-11-23 – 2026-05-23. Two new validated papers in chip_fabrication sector: paper-027 (TSMC 2026 North America Technology Symposium, VALIDATED) and paper-028 (Apple explores Intel/Samsung foundry alternatives, VALIDATED). All other sectors: no new papers this cycle.*

**[Run #4 — new conclusion]**: TSMC's High-NA EUV deferral is not a single-node delay — it is a structural multi-node decision covering TSMC's entire leading-edge roadmap through 2029. TSMC 2026 North America Technology Symposium (paper-027 chip_fabrication, April 22-23, 2026, VALIDATED): TSMC introduced A13 (2029) and A12 (2029) as the next two leading-edge nodes below A14, explicitly confirming both will use conventional 0.33 NA EUV, not High-NA. Combined with N2U (2028, no High-NA) and A16 slipping to 2027, TSMC's entire foundry roadmap from 2026 through at minimum 2029 will operate on conventional EUV. This revises Run #3's conclusion ("a 2-year High-NA divergence") upward: the Samsung/Intel capability advantage in sub-8nm half-pitch patterning is now a structural ≥3-year window spanning multiple node generations. The conclusion for chip_fabrication C7 (EUV ceiling) and cross_sector_alpha Finding 6: Samsung HBM5 base-die logic on High-NA EUV achieves demonstrably tighter via pitch than any TSMC-manufactured logic die through 2029. For HBM5 procurement, process-node capability is now a product-differentiation variable. **Confidence: high (TSMC primary press release + multiple Tier-3 corroborations; the absence of High-NA is explicitly confirmed by TSMC, not inferred).**

**[Run #4 — new conclusion]**: For the first time, a credible demand-side mechanism for TSMC N2 capacity relief has been publicly reported. Apple explores Intel and Samsung as TSMC foundry alternatives (paper-028 chip_fabrication, Bloomberg May 5, 2026, VALIDATED): Apple is in early-stage discussions to use Intel 18A and/or Samsung SF2X to manufacture lower-end chips, with no contracts and a 2027-2028 timeline. The cross-sector implication: Apple's >50% TSMC N2 allocation — long treated as an immovable structural constraint on AI chip supply — has a partial relief mechanism for the first time. If Apple moves even 15-20% of its lower-end silicon to Intel or Samsung, the freed N2 capacity accrues to the queue of AI chip customers. This does not resolve the AI chip supply constraint in 2026, but it introduces a credible scenario for partial capacity relief in 2027-2028 that no prior sell-side model has incorporated. Additionally: Intel Foundry Services gaining Apple as a customer would transform the IFS investment thesis from a "make-or-break yield story" to a "validated Tier-1 external foundry." **Confidence: medium (Bloomberg primary source with corroboration; "early-stage discussions" implies high uncertainty on execution).**

**[Run #4 — no new cross-sector conclusions]**: No additional cross-sector conclusions arise from this cycle beyond the two above. Run #4 is a minor refresh — 2 new papers in 1 sector, no new verified-non-consensus findings.
